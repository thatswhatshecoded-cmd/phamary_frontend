...
export function BrandLogo({ dark = false, showName = true }: BrandLogoProps) {
  return (
    <div className="flex items-center gap-2" aria-label="ApniPharma">
      ...
      {showName && <span className={`text-[30px] font-light tracking-[-1.5px] ${dark ? "text-[#062f58]" : "text-white"}`}>ApniPharma</span>}
